...
keys.globalkeys = gears.table.join(
    ...
    -- Media keys
    awful.key({ superkey }, "period", function() awful.spawn.with_shell("playerctl --player=spotify next") end,
        {description = "next song", group = "media"}),
    awful.key({ superkey }, "comma", function() awful.spawn.with_shell("playerctl --player=spotify previous") end,
        {description = "previous song", group = "media"}),
    awful.key({ superkey }, "space", function() awful.spawn.with_shell("playerctl --player=spotify play-pause") end,
