...
local petal_top_left = create_url_petal("GIthub", x.color4, x.color12, "https://github.com/", true, true, false, true)
local petal_top_right = create_url_petal("Youtube", x.color1, x.color9, "https://youtube.com/", true, true, true, false)
local petal_bottom_right = create_url_petal("Twitch", x.color2, x.color10, "https://www.twitch.tv/",false, true, true, true)
local petal_bottom_left = create_url_petal("Reddit", x.color3, x.color11, "https://reddit.com/",true, false, true, true)
